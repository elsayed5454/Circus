...
public class Circus implements World {
    ...
    FlyweightShapeFactory FlyweightimageFactory;
    ImagePool imagePool;
    IStrategy strategy;
    ...
    // Factories
    private GameObjectFactory constantFactory = new ConstantObjectFactory();
    private GameObjectFactory controllableFactory = new ControllableObjectFactory();
